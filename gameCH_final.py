...
TamanhoJogo = pygame.mixer.Sound("sounds/samba_normal_2_0.7.ogg")
tempodemusica = TamanhoJogo.get_length()
print("tamanho da musica", tempodemusica)
...
def makesListVirada():
    ...
    x = 1.3
    buttonList = (
    [12.1-x, 17.8-x, 23.6-x, 25-x, 30.1-x, 31.5-x, 36.6-x, 38-x, 43.1-x, 44.5-x, 48.7-x, 52.2-x, 52.9-x, 57.8-x, 61.1-x, 64.6-x, 65.3-x, 70.2-x, 105.6, 108.9, 109.6, 114.5, 117.3, 120.8, 121.5, 126.4],
    [10.7-x, 12.9-x, 16.6-x, 50.8-x, 53.6-x, 57.1-x, 63.2-x, 66-x, 69.5-x, 74.5-x, 75.2-x, 76-x, 76.7-x, 77.5-x, 78.2-x, 79-x, 79.8-x, 80.6-x, 81.3-x, 82.1-x, 82.8-x, 83.6-x, 84.3-x, 85.1-x, 85.9-x, 86.7-x, 107.5, 110.3, 113.8, 119.4, 122.2, 125.7],
    [11.6-x, 15.2-x, 17.2-x, 22.9-x, 24.3-x, 29.4-x, 30.8-x, 35.9-x, 37.3-x, 42.4-x, 43.8-x, 48-x, 49.4-x, 55.7-x, 60.4-x, 61.8-x, 68.1-x, 98.5, 99.1, 100, 100.6, 101.5, 102.1, 103, 104.9, 106.1, 112.4, 116.6, 118, 124.3, 128.5],
    [19.2-x, 50.1-x, 54.3-x, 55.0-x, 58.5-x, 59.2-x, 62.5-x, 66.7-x, 67.4-x, 70.9-x, 75.6-x, 77.1-x, 78.6-x, 79.4-x, 80.2-x, 81.7-x, 83.2-x, 84.7-x, 85.5-x, 86.3-x, 106.8, 111.0, 111.7, 115.2, 118.7, 122.9, 123.6, 127.1, 127.8],
    [6.9-x, 7.4-x, 7.9-x, 10-x, 16.0-x, 22.2-x, 28.7-x, 35.2-x, 41.7-x, 47.3-x, 51.5-x, 56.4-x, 59.7-x, 63.9-x, 68.8-x, 90.5-x, 91.3-x, 92.1-x, 92.9-x, 96.2-x, 97-x, 97.8-x, 98.6-x, 104.2, 108.2, 113.1, 115.9, 120.1, 125, 129.2])
...
def drawScene():
    ...
    global musicaJogo, contador_musica_derrota
    global onPause
...
def contRegress():
    ...
    global CarniChegou
    global atual_frame_rect
    global timePause, contador_musica_vitoria
    global playerGanhou
